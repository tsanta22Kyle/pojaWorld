package com.hei.project.endpoint.event.model;

import static com.hei.project.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.hei.project.PojaGenerated;
import com.hei.project.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.hei.project.event1";
    return "com.hei.project.event2";
  }
}
