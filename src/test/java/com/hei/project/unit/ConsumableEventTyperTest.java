...
import com.hei.project.conf.FacadeIT;
import com.hei.project.endpoint.event.consumer.model.ConsumableEvent;
import com.hei.project.endpoint.event.consumer.model.ConsumableEventTyper;
import com.hei.project.endpoint.event.consumer.model.TypedEvent;
import com.hei.project.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.hei.project.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.hei.project.endpoint.event.model.UuidCreated", payload);
